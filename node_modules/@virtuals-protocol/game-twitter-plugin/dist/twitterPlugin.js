...
var twitterPlugin_exports = {};
__export(twitterPlugin_exports, {
  default: () => twitterPlugin_default
});
module.exports = __toCommonJS(twitterPlugin_exports);
    ...
    return new import_game.GameFunction({
      ...
      executable: (args, logger) => __async(this, null, function* () {
        try {
          ...
          yield this.twitterClient.v2.reply(args.reply, args.tweet_id);
          return new import_game.ExecutableGameFunctionResponse(
            import_game.ExecutableGameFunctionStatus.Done,
            "Replied to tweet"
          );
