import { TweetV2PostTweetResult, TweetSearchRecentV2Paginator, TweetV2LikeResult, UserV2Result, TweetUserMentionTimelineV2Paginator, UserV2TimelineResult, DirectMessageCreateV1Result, DmEventsV1Paginator } from 'twitter-api-v2';

type MediaIdsType = [string] | [string, string] | [string, string, string] | [string, string, string, string];
interface ITweetClient {
    ...
    reply(tweet_id: string, reply: string, mediaIds?: MediaIdsType): Promise<TweetV2PostTweetResult>;
    like(tweet_id: string): Promise<TweetV2LikeResult>;
    quote(tweet_id: string, quote: string, mediaIds?: MediaIdsType): Promise<TweetV2PostTweetResult>;
...
export type { ITweetClient, MediaIdsType };
