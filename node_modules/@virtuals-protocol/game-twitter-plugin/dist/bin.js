...
var require_open = __commonJS({
  "node_modules/open/index.js"(exports2, module2) {
    ...
    var getWslDrivesMountPoint = /* @__PURE__ */ (() => {
      ...
      return function() {
        return __async(this, null, function* () {
          ...
          const configContent = yield fs.readFile(configFilePath, { encoding: "utf8" });
    ...
    var pTryEach = (array, mapper) => __async(null, null, function* () {
      let latestError;
    ...
    var baseOpen = (options) => __async(null, null, function* () {
...
var getLoginUrl = (apiKey) => __async(null, null, function* () {
...
var verify = (code, state) => __async(null, null, function* () {
...
program2.name("game-twitter-plugin").description("CLI to authenticate and interact with GAME's Twitter API").version("0.1.0");
program2.command("auth").description("Authenticate with Twitter API").option("-k, --key <char>", "project's API key").action((options) => {
  const apiKey = options.key;
  if (!apiKey) {
    console.error("API key is required!");
    return;
  }
  const server = import_http3.default.createServer((req, res) => __async(null, null, function* () {
    var _a;
    if (req.method === "GET" && ((_a = req.url) == null ? void 0 : _a.startsWith("/callback"))) {
  ...
  server.listen(8714, () => __async(null, null, function* () {
    const url2 = yield getLoginUrl(apiKey);
    console.log("\nWaiting for authentication...\n");
    console.log("Visit the following URL to authenticate:");
    console.log(url2, "\n");
    yield (0, import_open.default)(url2);
  }));
});
program2.parse();
